...
class GA(object):
    ...
    def crossover(self, parent, pop):
        if np.random.rand() < self.cross_rate:
            ...
            parent[cross_points] = pop[i_, cross_points]    # mating and produce on child
        return parent
...
ga = GA(DNA_size=DNA_SIZE, DNA_bound=DIRECTION_BOUND, cross_rate=CROSS_RATE, mutation_rate=MUTATE_RATE, pop_size=POP_SIZE)
